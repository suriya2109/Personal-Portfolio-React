# Personal Portfolio Website - Suriya Periyasamy
...
[**View Portfolio on Vercel**](https://personal-portfolio-react-rust.vercel.app/)
...
1.  Clone the repo
    ```sh
    git clone https://github.com/suriya2109/Personal-Portfolio-React
    ```
